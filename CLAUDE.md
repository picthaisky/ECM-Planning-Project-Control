...
- **Design system:** Warm orange-brown theme — Primary `#E26D5C`, Deep Amber `#A1523E` (critical path), Warm Slate `#2B2523`, Ivory `#FDFBF7`, Success `#52B788`, Forecast blue `#4EA8DE`. Fonts: Inter / IBM Plex Sans Thai.
